<#
.SYNOPSIS
Get and switch UAC level

.DESCRIPTION
Gets the current UAC level and allows switch to another UAC level.

.PARAMETER Get-UACLevel
Gets the current UAC level

.PARAMETER Set-UACLevel
Sets the UAC level to a new one

.EXAMPLE
Set_UACLEVEL 0
Sets the UAC level to Never Notify
